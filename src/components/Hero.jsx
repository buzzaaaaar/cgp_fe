...
function Hero() {
  ...
  const handleAccept = () => {
    ...
    // You can add additional logic here to set cookies
  };

  const handleReject = () => {
    setShowCookieNotice(false);
    localStorage.setItem('cookiePreference', 'rejected');
    // You can add additional logic here to handle rejection
  };
          ...
          <div className="w-full max-w-4xl bg-white rounded-[15px] shadow-lg p-6 font-sans">
            ...
            <div className="flex justify-end space-x-4">
              <button 
                ...
                className="bg-[#7FAF37] hover:bg-[#6c9b2f] text-white font-semibold px-6 py-2 rounded-[15px] transition"
              >
                ACCEPT ALL
              </button>
              <button 
