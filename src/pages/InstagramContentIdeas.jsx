...
import instacaption from '../assets/instacaption.png';
import instahashtag from '../assets/instahashtag.png';
...
export default function InstagramContentIdeas() {
  ...
  return (
    <div className="min-h-screen bg-white font-hanken px-4 sm:px-8 py-6">
      ...
      <div className="mb-6">
        <h1 className="text-5xl font-extrabold text-[#7FAF37] mb-4">Instagram Content Ideas</h1>
          ...
          <h2 className="text-xl font-semibold text-[#7FAF37] text-center mb-6">Related Tools</h2>
           ...
           <div className="border border-gray-200 rounded-lg p-4 mb-6 bg-white min-h-[150px] shadow-lg w-full max-w-sm">
            <div className="flex items-center mb-2">
              <img src={instahashtag} alt="Blog Post Ideas" className="w-6 h-6 mr-2" />
              <h3 className="text-base font-semibold text-[#013024]">Instagram Hashtag Generator</h3>
            </div>
            <p className="text-sm text-gray-600 mb-2">
            Generate effective Instagram hashtags to expand your reach and connect with your audience
            </p>
           ...
           <div className="border border-gray-200 rounded-lg p-4 mb-6 bg-white min-h-[150px] shadow-lg w-full max-w-sm">
            <div className="flex items-center mb-2">
              <img src={instacaption} alt="Blog Post Ideas" className="w-6 h-6 mr-2" />
              <h3 className="text-base font-semibold text-[#013024]">Instagram Caption Generator</h3>
            </div>
            <p className="text-sm text-gray-600 mb-2">
            Create captivating and creative captions to boost engagement on your Instagram posts
            </p>
            <div className="text-sm text-[#013024] text-right cursor-pointer hover:underline hover:text-[#7FAF37]">Learn more</div>
          </div>
