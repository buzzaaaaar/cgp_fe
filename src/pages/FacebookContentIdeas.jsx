...
export default function FacebookCaptionGenerators() {
          ...
          <h2 className="text-xl font-semibold text-[#7FAF37] text-center mb-6">Related Tools</h2>
           ...
           <div className="border border-gray-200 rounded-lg p-4 mb-6 bg-white min-h-[150px] shadow-lg w-full max-w-sm">
            <div className="flex items-center mb-2">
              <img src={FBhashtag} alt="Blog Post Ideas" className="w-6 h-6 mr-2" />
              <h3 className="text-base font-semibold text-[#013024]">Facebook Hashtag Generator</h3>
            </div>
            <p className="text-sm text-gray-600 mb-2">
            Generate trending Facebook hashtags to amplify your post visibility and interactions
            </p>
