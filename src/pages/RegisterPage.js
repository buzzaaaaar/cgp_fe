    ...
    <div className="flex h-screen font-hanken">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white relative">
        <div className="max-w-md w-full px-12 py-10">
          ...
          <h2 className="text-left text-2xl font-bold text-gray-900">Sign Up</h2>
          {submitError && (
          ...
          <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                placeholder={usernameError ? 'Username must be at least 3 characters' : ''}
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium" style={{ color: '#000000' }}>
                Confirm Password*
              </label>
              <input
                id="confirmPassword"
                ...
                placeholder={confirmPasswordError ? 'Passwords do not match' : ''}
                className="appearance-none rounded-[8px] relative block w-full px-3 py-2 border text-gray-900 focus:outline-none focus:ring-green-600 focus:border-green-600 focus:z-10 sm:text-sm mt-1"
                style={{
                  borderColor: '#000000',
                  color: '#000000',
